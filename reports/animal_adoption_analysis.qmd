...
::: {layout-ncol=2}
![Adoption rates by animal intake condition](../results/figures/adoption_by_intake_condition.png){#fig-intake-condition}

![Adoption rates by intake type](../results/figures/adoption_by_intake_type.png){#fig-intake-type}
:::
...
![Histogram of age distribution by adoption status](../results/figures/age_distribution.png){#fig-age-distribution width=75%}

![Boxplot showing age distribution by adoption status](../results/figures/age_boxplot_additional.png){#fig-age-boxplot width=75%}
